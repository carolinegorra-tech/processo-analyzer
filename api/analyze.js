...
<title>Processo Analyzer — Extração com IA</title>
...
<div class="header">
  <div>
    <div class="header-label">Análise com IA</div>
    <div class="header-title">Processo Analyzer — Trabalhista</div>
  </div>
...
<div class="container">
  <div id="uploadZone" class="upload-zone" ondragover="event.preventDefault();this.classList.add('dragging')" ondragleave="this.classList.remove('dragging')" ondrop="handleDrop(event)" onclick="document.getElementById('fileInput').click()">
    ...
    <div class="upload-filename" id="fileName">Aceita qualquer PDF trabalhista — qualquer tamanho</div>
    <input id="fileInput" type="file" accept=".pdf" onchange="handleFile(event)" style="display:none">
  </div>
  <div id="uploadFooter" class="upload-footer">34 campos extraídos automaticamente · Sentença · TRT · TST · Execução</div>
  ...
  <div id="resultsSection" class="results-section hidden">
    <div class="results-header"><div class="section-label">Resultado da Análise</div><button class="export-btn" onclick="exportCSV()">⬇ Exportar CSV</button></div>
...
var FIELDS=[
  ...
  {key:"numero_processo",label:"1. Número do processo"},
  ...
  {cat:"Detalhes da Ação"},
  {key:"valor_causa",label:"12. Valor da causa"},
  {key:"pedidos_inicial",label:"13. Pedidos da inicial"},
  {key:"data_admissao",label:"14. Data de admissão"},
  {key:"data_demissao",label:"15. Data de demissão"},
  {cat:"Audiência"},
  {key:"data_audiencia",label:"16. Data da audiência"},
  {key:"tipo_audiencia",label:"17. Tipo de audiência"},
  ...
  {key:"sentenca",label:"21. Sentença"},
  {key:"sentenca_enquadramento",label:"22. Sentença — enquadramento?"},
  {key:"sentenca_jornada_externa",label:"23. Sentença — jornada externa?"},
  {cat:"TRT"},
  {key:"resumo_trt",label:"24. Resumo do TRT"},
  {key:"acordao_trt_enquadramento",label:"25. Acórdão TRT — enquadramento?"},
  {key:"acordao_trt_jornada_externa",label:"26. Acórdão TRT — jornada externa?"},
  {key:"sustentacao_oral",label:"27. Sustentação oral?"},
  {cat:"TST"},
  {key:"acordao_tst",label:"28. Acórdão TST"},
  {key:"acordao_tst_enquadramento",label:"29. Acórdão TST — enquadramento?"},
  {key:"acordao_tst_jornada_externa",label:"30. Acórdão TST — jornada externa?"},
  {cat:"Andamento e Execução"},
  {key:"data_ultimo_andamento",label:"31. Data do último andamento"},
  {key:"resumo_ultimo_andamento",label:"32. Resumo do último andamento"},
  {key:"numero_execucao_provisoria",label:"33. Nº execução provisória"},
  {key:"valor_homologado_execucao",label:"34. Valor homologado na execução"}
];

var SYSTEM_PROMPT = "O Agente analisará o texto extraído do PDF. Utilize sempre o modo de alto esforço. O número do processo é o que consta na nomeação do arquivo, sendo assim, sempre que for inserir qualquer informação confira se o número da peça/decisão/sentença/acordão bate com o número do arquivo. Ignore provas emprestadas de outros processos juntados com a petição. Não utilize informações de \"provas emprestadas\", inicial, contestação, acórdãos, decisões interlocutórias, ou quaisquer documentos diversos da sentença do processo original. Validação de partes: confirme que o(a) autor(a)/reclamante indicado(a) na sentença coincide com o(a) autor(a)/reclamante da petição inicial dos autos.\n\nColunas:\n\n1. numero_processo: Formato CNJ: NNNNNNN-DD.AAAA.JTR.OOOO.\n\n2. status_processo: Arquivado: quando houver arquivamento por certidão do próprio juízo. Analise apenas despachos, decisões e certidões do juízo. Certidão de trânsito em julgado NÃO SIGNIFICA ARQUIVADO. Se não houver, indique \"Ativo\".\n\n3. data_arquivamento: DD/MM/AAAA. Necessariamente haverá a palavra arquivamento na certidão do juízo ou despacho. Não considere certidão de decurso de prazo. Não considere documentos das partes, petições, anexos ou sumário. Procure apenas em despachos, decisões e certidões do juízo. Ignore o índice. Não invente informações. Certidão de trânsito em julgado NÃO É DE ARQUIVAMENTO.\n\n4. nome_reclamante: Nome completo, consta na capa do processo ou topo das decisões.\n\n5. patrono_reclamante: Advogado do reclamante, consta na capa. Não confundir com reclamante. Sem abreviar. Se não houver capa, ver final das petições do reclamante. Múltiplos: separar por \";\".\n\n6. reclamadas: Nome completo das reclamadas. Campo \"RECLAMADO: XXX\" na capa. Razão social completa. EM LETRAS MAIÚSCULAS.\n\n7. comarca: Por extenso. Ex: São Paulo.\n\n8. vara: Por extenso. Ex: 4ª Vara do Trabalho de Campinas/SP.\n\n9. nome_juiz: Sem abreviações. Usar último despacho ou ata de audiência.\n\n10. turma_trt: Ex: 1ª Turma do Tribunal Regional da 15ª Região.\n\n11. turma_tst: Ex: 1ª Turma do Tribunal Superior do Trabalho.\n\n12. valor_causa: R$ XXXXX,XX.\n\n13. pedidos_inicial: Termos nucleares da seção \"Pedidos\"/\"Requerimentos\". Ex: \"Enquadramento sindical; Horas extras\". Sem justiça gratuita, honorários.\n\n14. data_admissao: DD/MM/AAAA se constar em sentença, TRCT ou docs oficiais.\n\n15. data_demissao: DD/MM/AAAA se constar em sentença, TRCT ou docs oficiais.\n\n16. data_audiencia: Datas de audiências futuras. DD/MM/AAAA.\n\n17. tipo_audiencia: \"Inicial\", \"UNA\", \"Instrução\" ou \"Conciliação\".\n\n18. testemunhas_reclamada: Nomes E CPF das testemunhas da reclamada ouvidas. Ata de Audiência, seção \"qualificação\". Múltiplas: \";\".\n\n19. testemunhas_reclamante: Idem para testemunhas do reclamante.\n\n20. fase_atual: Conhecimento / Recursal / Execução / Suspenso / Arquivado.\n\n21. sentenca: Procedentes e Improcedentes. Não usar \"provas emprestadas\". Validar partes.\n\n22. sentenca_enquadramento: \"sim\" se deferiu enquadramento financeiro; \"não\" se indeferiu; \"n/a\" se não existiu pedido. Fonte: sentença de 1º grau. Ignorar docs de outros processos.\n\n23. sentenca_jornada_externa: \"sim\" se reconheceu jornada externa e horas extras improcedente; \"não\" se não reconheceu. Fonte: sentença de 1º grau.\n\n24. resumo_trt: 1–2 frases. Mantida ou reformada e o quê.\n\n25. acordao_trt_enquadramento: \"sim\"/\"não\"/\"n/a\". Fonte: acórdão de 2º grau.\n\n26. acordao_trt_jornada_externa: \"sim\"/\"não\". Fonte: ACÓRDÃO DO 2º GRAU.\n\n27. sustentacao_oral: \"Sim\" ou \"Não\". Final do acórdão.\n\n28. acordao_tst: 1–2 frases do resultado no TST.\n\n29. acordao_tst_enquadramento: \"sim\"/\"não\"/\"n/a\". Fonte: acórdão de 3º grau.\n\n30. acordao_tst_jornada_externa: \"sim\"/\"não\". Fonte: ACÓRDÃO do próprio processo.\n\n31. data_ultimo_andamento: DD/MM/AAAA da última movimentação.\n\n32. resumo_ultimo_andamento: Breve resumo do último andamento.\n\n33. numero_execucao_provisoria: Formato CNJ ou \"N/A\".\n\n34. valor_homologado_execucao: Valor homologado ou \"N/A\".\n\nRESPONDA APENAS COM JSON VÁLIDO contendo as 34 chaves. Sem markdown, sem backticks, sem explicações.";
...
async function extractText(buf){
  ...
  for(var i=1;i<=pdf.numPages;i++){
    ...
    if(i%20===0) setProgress(10+Math.round((i/pdf.numPages)*25),'Extraindo página '+i+' de '+pdf.numPages+'...');
  }
...
async function analyze(){
  ...
  setProgress(5,'Iniciando extração de texto...');
  ...
  try{
    ...
    if(fullText.length<50)throw new Error('PDF sem texto extraível. Pode precisar de OCR.');

    setProgress(35,'Preparando texto para análise...');

    // Build text in normal order only (to maximize content within limit)
    var text='';
    for(var j=0;j<pages.length;j++){if(pages[j].trim())text+='--- PÁG '+(j+1)+'/'+total+' ---\n'+pages[j]+'\n\n'}

    // Truncate if too long (Claude max ~200k tokens)
    if(text.length>800000) text=text.substring(0,800000)+'\n[TRUNCADO - PDF muito grande]';

    setProgress(45,'Enviando para Claude analisar (pode levar até 1 min)...');
    ...
    if(!parsed)throw new Error('Resposta inválida do Claude.');

    analysisResults=parsed;setProgress(100,'Concluído!');
    renderResults(parsed);show($('resultsSection'));
    $('headerStatus').textContent='✅ Análise concluída — '+total+' páginas';
    $('footerNote').textContent='Análise gerada por Claude AI · '+new Date().toLocaleDateString('pt-BR');show($('footerNote'));
...
function resetAll(){
  ...
  $('fileName').textContent='Aceita qualquer PDF trabalhista — qualquer tamanho';$('fileInput').value='';
}
